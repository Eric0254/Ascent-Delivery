...
const InternoPorsche911 = ({navigation}) => {
  const cars = [
    {
      name: 'Porsche911',
      price: 'R$400.00/d',
    ...
    <View style={styles.container}>
      <View style={styles.car}>
        ...
        <View style={styles.owner}>
          <Image source={{uri: "https://burst.shopifycdn.com/photos/smiling-man-in-blue.jpg?width=373&format=pjpg&exif=0&iptc=0"}} style={styles.ownerImage} />
          <Text style={styles.ownerName}>Proprietário</Text>
          <Text style={styles.ownerName}>Caio Ribeiro</Text>
        </View>
        <TouchableOpacity
...
export default InternoPorsche911;
