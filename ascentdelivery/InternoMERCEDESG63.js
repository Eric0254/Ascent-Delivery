...
const InternoMERCEDESG63 = ({navigation}) => {
  const cars = [
    {
      name: 'MERCEDESG63',
      price: 'R$600.00/d',
      distance: '10.5km',
      imagem: 'https://carsguide-res.cloudinary.com/image/upload/f_auto,fl_lossy,q_auto,t_default/v1/editorial/vhs/Mercedes-amg-g63.png'
    },
    {
      name: 'Porsche911',
...
export default InternoMERCEDESG63;
